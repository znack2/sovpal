     ...
     <div class="form-group">
      ...
      <div class="col-sm-2">
        ...
        {{-- {{ (old('start_remont')) ? old('start_remont') : '' }} --}}
         <input autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" class="form-control" type="text" name="start_remont" onchange="this.form.submit()"
         placeholder="{{ $room->start_remont or trans('sovpal.forms.startRemont') }}" >
      ...
      <div class="col-sm-2">
           ...
           <input autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" class="form-control" type="text" name="end_remont" onchange="this.form.submit()"
           placeholder="{{ $room->end_remont or trans('sovpal.forms.endRemont') }}" >
      ...
      <div class="col-sm-2">
       ...
       {{-- <label for="area" class="col-sm-2 control-label">{{ trans('sovpal.area') }}</label> --}}
           <input autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" class="form-control" type="number" name="area" onchange="this.form.submit()"
           placeholder="{{ $room->area or trans('sovpal.forms.area') }}" >

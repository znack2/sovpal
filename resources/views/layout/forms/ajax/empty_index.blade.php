...
<div class="col-md-12 form-group">
	<input autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" id="empty_form" type="checkbox" name="empty_form"
	class="css-checkbox" onchange="this.form.submit()">
